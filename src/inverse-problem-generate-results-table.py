...
expdir = os.path.abspath("src\\experiment-data")
expname = "inverse-validation-exp5~multiple"
...
for j in range(len(datafiles)):
    ...
    summary_table.to_excel(os.path.join(dirname, f"single_{expname}_summary.xlsx"))
